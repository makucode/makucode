        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2000 1500">
            ...
            <defs>
                ...
                <pattern
                    ...
                    patternTransform="rotate(260 1000 750) scale(19.2) translate(-947.92 -710.94)"
                >
                    <use fill="#2c2c2c" href="#s" y={2} />
                    <use fill="#2c2c2c" href="#s" x={1} y={2} />
                    <use fill="#393939" href="#s" x={2} y={2} />
                    <use fill="#393939" href="#s" />
                    <use fill="#434343" href="#s" x={2} />
                    <use fill="#434343" href="#s" x={1} y={1} />
                </pattern>
                <pattern
                    id="b"
                    width={7}
